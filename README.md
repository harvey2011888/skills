...
打开 `weekly_report.md` 即可看到完整的周报！

## 📁 文件说明

### 核心文件
- [`weekly_report_generator.py`](weekly_report_generator.py) - 核心库（432 行）
- [`cli.py`](cli.py) - 命令行工具（112 行）
- [`test_report.py`](test_report.py) - 测试脚本（180 行）

### 文档文件
- [`QUICKSTART.md`](QUICKSTART.md) - **5 分钟快速上手指南** ⭐ 推荐从这里开始
- [`README_SKILL.md`](README_SKILL.md) - 完整使用文档
- [`PROJECT_SUMMARY.md`](PROJECT_SUMMARY.md) - 项目总结和技术架构
- [`完成总结.md`](完成总结.md) - 参赛完成总结
- [`参赛帖子.md`](参赛帖子.md) - 参赛帖子正文

### 示例文件
- [`config.example.json`](config.example.json) - 配置文件示例
- [`tasks.example.json`](tasks.example.json) - 任务文件示例
- [`sample_report.md`](sample_report.md) - 示例周报
...
```bash
# 基础用法
python cli.py --author "张三" --team "开发组" --output report.md
...
### 新手入门
1. 先看 [QUICKSTART.md](QUICKSTART.md) - 5 分钟快速上手
2. 运行 `python test_report.py` 查看测试效果
3. 运行 `./demo.sh` 体验完整功能

### 深入学习
1. 阅读 [README_SKILL.md](README_SKILL.md) - 完整功能说明
2. 查看 [PROJECT_SUMMARY.md](PROJECT_SUMMARY.md) - 技术架构详解
3. 参考配置示例和任务示例

### 参赛相关
1. [参赛帖子.md](参赛帖子.md) - 参赛正文
2. [完成总结.md](完成总结.md) - 参赛总结
